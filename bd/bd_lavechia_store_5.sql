...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 04-Jun-2024 às 20:43
...
(1, 'RIAN', 'PAIVA DA SILVA', '49043588806', 'M', '119863183463', 'rianpaiva0@gmail.com', '$2y$10$uSrt8.ADs28vcEsuMYG3HuIiVNakF81wGWC.oZ0RYvClr52Dj2ek6', 1),
...
(50, 'PAIVA', 'DEV', '', 'M', '(11) 96318-34', 'paiva.dev@gmail.com', '$2y$10$LBiIum8E5IymhhEe/yADwOq2yNmAPDFa.lh0T3WAB2OjeT1SOEOcO', 1),
(51, 'GABRIEL', 'VAVA DE LIMA', '', 'M', '(11) 96318-34', 'sejax94910@javnoi.com', '$2y$10$KPuZV2XMz9B5QM/RQvw9vu89yAKmday01nZyDv2uXj6ZNGEsNv/sy', 1),
(52, 'MAILER', 'VAVA DE LIMA', '', 'M', '(11) 96318-34', 'abdelmounaim1262@uorak.com', '$2y$10$aBLydvo14TPapaYK6gO6sOPrwPxZfbaqlOpQpd/G9YswH6p9NxQWW', 1),
(53, 'ISABELLI', 'OLIVEIRA', '', 'F', '(11) 98098-22', 'isabelli.camargo29@gmail.com', '$2y$10$7fwbspqnHP59ts33b/UPGeIQHdcVWDx84uozr8XUFJOCDcX1s3A1i', 1),
(54, 'ISABELLI', 'OLIVEIRA', '', 'F', '(11) 98098-22', 'isabelli.camrgo29@gmail.com', '$2y$10$1gKSJVahygEq03MSMJSyPufS6H3NwtQRWNjzS0XQE.kHkNlpNZo8a', 1);
...
(6, 1, 'EDEMAR FONSECA', 'VILA ROSALINA', 'FRANCO DA ROCHA', '26', 119, 'CASA', '07987000'),
(7, 1, 'RUA ALOISIO DE AZEVEDO', 'JARDIM DAS BANDEIRAS', 'MOGI DAS CRUZES', '26', 31, '', NULL);
...
(15, 'PAIVA DISTRIBUIDORA 02', '51975017000103', 'paiva.roupas@gmail.com', '(11) 96318-34', 1, 'FRACISCO MORATO', 'JARDIM ALEGRIA', 26, 'APT 2', 123, 1),
...
--
-- Extraindo dados da tabela `tb_item_estoque`
--
...
(44, 324.00, '2023-12-02 13:27:00', 1, '{\"35\": 10, \"36\": 20, \"37\": 50}'),
(45, 250.00, '2023-12-04 08:04:00', 1, '{\"35\": 5, \"36\": 2, \"37\": 3}');
...
INSERT INTO `tb_item_pedido` (`id_pedido`, `id_produto`, `valor_venda`, `qtd`, `tamanho`) VALUES
(18, 44, 324.00, 1, 37),
(19, 13, 399.00, 1, 37),
(20, 43, 250.00, 1, 37),
(21, 45, 250.00, 1, 35),
...
CREATE TABLE IF NOT EXISTS `tb_pedido` (
  ...
  `frete` double(10,2) NOT NULL DEFAULT '0.00',
...
INSERT INTO `tb_pedido` (`id_pedido`, `id_endereco`, `id_cliente`, `preco_total`, `data_pedido`, `status_pagamento`, `frete`) VALUES
(18, 1, 1, 400.00, '2023-12-04 22:24:27', 0, 10.28),
(19, 1, 1, 399.00, '2023-12-04 22:31:46', 0, 10.28),
(20, 1, 1, 260.28, '2023-12-04 22:53:35', 0, 0.00),
(21, 1, 1, 250.00, '2023-12-04 23:06:13', 0, 0.00),
(22, 1, 1, 261.86, '2024-03-01 23:22:15', 0, 11.86),
(23, 1, 1, 764.30, '2024-03-02 16:32:57', 0, 14.30),
(24, 1, 1, 750.00, '2024-05-10 23:24:42', 0, 0.00),
(25, 1, 1, 250.00, '2024-05-11 00:20:32', 0, 10.78),
(26, 1, 1, 712.95, '2024-05-19 01:19:28', 0, 12.95),
(27, 1, 1, 900.00, '2024-05-26 01:20:24', 0, 12.95),
(28, 1, 1, 450.00, '2024-05-26 18:21:15', 0, 10.78),
(29, 1, 1, 450.00, '2024-05-26 18:23:44', 0, 10.78),
(30, 1, 1, 250.00, '2024-05-26 18:45:11', 0, 10.78),
(31, 1, 1, 250.00, '2024-05-26 18:52:55', 0, 10.78),
(32, 1, 1, 100.00, '2024-05-26 19:28:24', 0, 599.00),
(33, 1, 1, 324.00, '2024-05-26 19:55:10', 0, 10.78),
(34, 1, 1, 300.00, '2024-05-26 20:01:32', 0, 10.78),
(35, 1, 1, 100.00, '2024-05-26 20:06:12', 0, 599.00),
(36, 1, 1, 100.00, '2024-05-26 20:17:12', 0, 599.00),
(37, 1, 1, 100.00, '2024-05-26 20:19:22', 0, 599.00),
(38, 1, 1, 100.00, '2024-05-26 20:23:12', 0, 599.00),
(39, 1, 1, 100.00, '2024-05-26 21:04:27', 0, 599.00),
(40, 1, 1, 100.00, '2024-05-26 21:14:26', 0, 599.00),
(41, 1, 1, 100.00, '2024-05-26 21:18:14', 0, 599.00),
(42, 1, 1, 100.00, '2024-05-26 21:20:48', 0, 599.00),
(43, 1, 1, 100.00, '2024-05-26 21:25:46', 0, 599.00),
(44, 1, 1, 100.00, '2024-05-26 21:27:59', 0, 599.00),
(45, 1, 1, 100.00, '2024-05-26 21:28:38', 0, 599.00),
(46, 1, 1, 100.00, '2024-05-31 21:58:49', 0, 599.00);
...
(44, 'NEW BALANCE HIGH', 15, 1, 'U', '../imagens_produto/NB9060MAIN.png', '../imagens_produto/NB9060SIDE.png', '', 'New Balance 2023', NULL),
(45, 'NIKE AIR MAX-90', 15, 1, 'U', '../imagens_produto/1 NIKE AIRMAX 90.png', '../imagens_produto/2 NIKE AIRMAX 90.png', '../imagens_produto/3 NIKE AIRMAX 90.png', 'Tênis de coleção e edição limitada', NULL);
...
(1, 'RIAN', ' PAIVA DA SILVA', 'paiva.dev@outlook.com', '$2y$10$uSrt8.ADs28vcEsuMYG3HuIiVNakF81wGWC.oZ0RYvClr52Dj2ek6', 1, 1);
...
ALTER TABLE `tb_item_carrinho`
  ADD CONSTRAINT `FK_tb_item_carrinho_tb_carrinho` FOREIGN KEY (`id_carrinho`) REFERENCES `tb_carrinho` (`id_carrinho`),
  ADD CONSTRAINT `FK_tb_item_carrinho_tb_produto` FOREIGN KEY (`id_produto`) REFERENCES `tb_produto` (`id_produto`);
...
ALTER TABLE `tb_produto`
  ADD CONSTRAINT `FK_tb_categoria` FOREIGN KEY (`id_categoria`) REFERENCES `tb_categoria` (`id_categoria`),
  ADD CONSTRAINT `FK_tb_produto_tb_fornecedor` FOREIGN KEY (`id_fornecedor`) REFERENCES `tb_fornecedor` (`id_fornecedor`),
  ADD CONSTRAINT `FK_tb_produto_tb_marca` FOREIGN KEY (`id_marca`) REFERENCES `tb_marca` (`id_marca`);
COMMIT;
